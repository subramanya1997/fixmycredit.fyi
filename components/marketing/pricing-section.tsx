        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="relative rounded-3xl border-2 border-slate-900 bg-slate-900 p-8 shadow-xl dark:border-white dark:bg-white">
            ...
            <div className="absolute -top-4 left-1/2 -translate-x-1/2">
              <span className="inline-flex rounded-full bg-emerald-500 px-4 py-1 text-sm font-semibold text-white shadow-lg">
                Best Value
              </span>
            </div>
            ...
            <div className="mb-8">
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-bold tracking-tight text-white dark:text-slate-900">
                  {siteConfig.pricing.annual.display}
                </span>
                <span className="text-slate-300 dark:text-slate-600">/year</span>
              </div>
            ...
            <div className="mb-8">
              <span className="inline-flex items-center rounded-full bg-slate-800 px-3 py-1 text-sm font-medium text-slate-300 dark:bg-slate-100 dark:text-slate-700">
                Coming Soon
              </span>
            </div>
